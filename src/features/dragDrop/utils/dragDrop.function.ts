...
import { ColumnNameType, IDragComponent } from '../types'
...
export const onDragEnd = (
  ...
  if (
    (source.droppableId as ColumnNameType) == 'sidebar' &&
    (destination.droppableId as ColumnNameType) == 'sidebar'
  ) {
    return
  }

  switch (source.droppableId as ColumnNameType) {
